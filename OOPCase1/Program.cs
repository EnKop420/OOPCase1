...
Student alexander = new(1, "Alexander", "Runge", new DateOnly(2005, 2, 5));
Student ozan = new(1, "Ozan", "Korkmaz", new DateOnly(1999, 12, 4));
Student camilla = new(1, "Camilla", "Kløjgaard", new DateOnly(1890, 4, 4));
Student dennis = new(1, "Dennis", "Paaske", new DateOnly(1980, 3, 4));
